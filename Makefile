...
zenkari: zenkari.c libraylib.a
	ifeq ($(PLATFORM_OS), PLATFORM_WINDOWS)
		$(CC) -Wall -Wextra -pedantic -std=c99 -O0 -ggdb -I ./raylib/src -o zenkari zenkari.c -L ./raylib/src -lraylib -lopengl32 -lgdi32 -lwinmm
	else
		$(CC) -Wall -Wextra -pedantic -std=c99 -O0 -ggdb -I ./raylib/src -o zenkari zenkari.c -L ./raylib/src -lraylib -lGL -lm -lpthread -ldl -lrt
	endif
